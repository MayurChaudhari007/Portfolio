...
const HomeSkills = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-16 md:py-24">
      ...
      {/* Skills Grid - 1 col on mobile, 2 on tablet, 3 on desktop */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-10">
        {skills.map((group, index) => (
          <div
            key={group.category || index}
            className="relative group rounded-[2.5rem] border border-slate-100 bg-white p-8 shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-indigo-100/50"
          >
            ...
            {/* Skill Pills - Optimized for touch and visibility */}
