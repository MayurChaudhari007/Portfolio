  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-5xl max-h-[80vh] flex flex-col items-center">
        ...
        <div className="mt-6 flex items-center gap-8">
          {images.length > 1 && (
            <button onClick={onPrev} className="sm:hidden text-white/50 p-2">
          ...
          {images.length > 1 && (
            <button onClick={onNext} className="sm:hidden text-white/50 p-2">
  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      <motion.header
        ...
        className="bg-white pt-16 pb-12 md:pt-24 md:pb-16 border-b border-slate-100"
      >
        <div className="max-w-7xl mx-auto px-6 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-4 tracking-tight uppercase">
            Activity <span className="text-indigo-600">Feed</span>
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="max-w-7xl mx-auto px-6 py-12 md:py-16 columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8"
      >
        {posts.map((post) => (
          <motion.div
            key={post._id}
