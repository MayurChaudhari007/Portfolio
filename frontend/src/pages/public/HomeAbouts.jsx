...
//         {/* IMAGE SKELETON */}
//         <div className="aspect-square max-w-[320px] sm:max-w-md mx-auto rounded-[2.5rem] border-8 border-white shadow-2xl bg-slate-200 animate-pulse" />
...
//       return data.data;
//     },
//     staleTime: 1000 * 60 * 60 * 24, // 24 hrs cache
...
//             >
//               <a href="https://github.com/MayurChaudhari007" target="_blank" rel="noreferrer" className="flex cursor-cta items-center gap-2 hover:text-black transition-colors">
//                 <i className="fa-brands fa-github text-lg"></i> GitHub
//               </a>

//               <a href="https://www.linkedin.com/in/mayur-chaudhari-7949752ba/" target="_blank" rel="noreferrer" className="flex cursor-cta items-center gap-2 hover:text-blue-600 transition-colors">
//                 <i className="fa-brands fa-linkedin text-lg"></i> LinkedIn
//               </a>

//               <a href="https://leetcode.com/u/ItsMeMayur/" target="_blank" rel="noreferrer" className="flex cursor-cta items-center gap-2 hover:text-orange-600 transition-colors">
//                 <i className="fa-solid fa-code text-lg"></i> LeetCode
//               </a>

//               <a href="https://x.com/itsmemayur007" target="_blank" rel="noreferrer" className="flex cursor-cta items-center gap-2 hover:text-black transition-colors">
...
const itemVariants = {
  hidden: { opacity: 0, y: 60 }, // Increased Y for more dramatic scroll effect
  show: {
    opacity: 1,
    y: 0,
    transition: {
  ...
  exit: { 
    opacity: 0, 
    y: -60, // Slides up and fades out when leaving
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            whileInView="show"
            exit="exit"
            viewport={{ once: false, amount: 0.2 }} // amount 0.2 means it triggers when 20% visible
            className="relative order-first lg:order-last"
          >
            <Tilt
              tiltMaxAngleX={8}
