  ...
  return (
    <section className="py-12 md:py-20 bg-white" id="contact">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="bg-slate-900 rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl flex flex-col lg:flex-row">
          
          {/* --- LEFT SIDE: INFO PANEL --- */}
          <div className="lg:w-2/5 bg-indigo-600 p-8 md:p-12 lg:p-16 text-white flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-sm md:text-base break-all">chaudharimayur485@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-sm md:text-base">Maharashtra, India</p>
                  </div>
                </div>
              </div>
            </div>

            {/* Social Mini Bar - Wrapped for mobile responsiveness */}
            <div className="mt-12 pt-8 border-t border-indigo-500/50">
              <p className="text-[10px] font-black uppercase tracking-widest text-indigo-200 mb-6">Connect with me:</p>
              <div className="flex flex-wrap gap-6">
                <a
                href="https://github.com/CodeWithMayur0007/Online-Health-Center"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="https://x.com/itsmemayur007?t=IfGMGWbhMQB-jTTiOowCAw&s=09"
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 hover:text-black transition-colors"
              >
          ...
          <div className="lg:w-3/5 p-8 md:p-12 lg:p-16 bg-white flex flex-col justify-center">
            {status === "success" ? (
              ...
              <form ref={form} onSubmit={sendEmail} className="space-y-8">
                ...
                <div className="pt-4 flex flex-col items-center md:items-start gap-4">
                  <button
                    ...
                    className="w-full sm:w-auto px-12 py-5 bg-indigo-600 text-white font-black uppercase tracking-widest text-xs rounded-2xl shadow-2xl shadow-indigo-100 hover:bg-indigo-700 hover:-translate-y-1 transition-all disabled:bg-slate-300 disabled:transform-none"
                  >
                    {status === "sending" ? (
